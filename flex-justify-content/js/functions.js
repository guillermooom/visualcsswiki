...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Establece el estado inicial del contenedor y el botón "center"
    const container = document.querySelector('.flex-container');
    container.style.justifyContent = 'start'; // Justificación por defecto
    ...
    buttons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            // Cambia la justificación del contenedor
            container.style.justifyContent = justification;
